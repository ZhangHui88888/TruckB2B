...
### 做什么
让 AI 客服能理解和回答不同语言的问题。

### 工作原理

```
用户用西班牙语问："¿Cuál es el pedido mínimo?"
                ↓
AI 自动提取英文关键词："minimum order MOQ"
                ↓
用英文关键词搜索知识库
                ↓
找到相关内容
...
| 英语 | "What is your MOQ?" | ✅ |
| 中文 | "最小起订量是多少？" | ✅ |
| 西班牙语 | "¿Cuál es el pedido mínimo?" | ✅ |
| 俄语 | "Какой минимальный заказ?" | ✅ |
| 阿拉伯语 | "ما هو الحد الأدنى للطلب؟" | ✅ |
